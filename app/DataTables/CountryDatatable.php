...
class CountryDatatable extends DataTable
{
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                'buttons' => [
                    ['extend' => 'create', 'className' => 'btn btn-success', 'text' => '<i class="fa fa-plus"> ' . trans('admin.new_country') . ' </i>'],
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::computed('id', 'ID')
                ...
                ->orderable(true)
                ->addClass('text-center'),
            Column::computed('country_name_ar', trans('admin.country_name_ar'))
                ->exportable(true)
                ->searchable(true)
                ->printable(true)
                ->orderable(true)
                ->addClass('text-center'),
            Column::computed('country_name_en', trans('admin.country_name_en'))
                ->exportable(true)
                ->searchable(true)
                ->printable(true)
                ->orderable(true)
