...
class SizeDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->rawColumns(['checkbox', 'is_public', 'edit', 'delete']);
    }
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                'buttons' => [
                    ['extend' => 'create', 'className' => 'btn btn-success', 'text' => '<i class="fa fa-plus"> ' . trans('admin.new_size') . ' </i>'],
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::computed('name_en', trans('admin.name_en'))
                ...
                ->orderable(true)
                ->addClass('text-center'),
            Column::computed('department_id.department_name_' . session('lang'), trans('admin.department_name_' . session('lang')))
                ->exportable(true)
                ->searchable(true)
                ->printable(true)
                ->orderable(true)
                ->addClass('text-center'),
            Column::computed('is_public', trans('admin.is_public'))
                ->exportable(true)
                ->searchable(true)
                ->printable(true)
                ->orderable(true)
