...
class ShippingCompanyDatatable extends DataTable
{
    ...
    {
        return $model->newQuery()->with('user_id')->select('shipping_companies.*');
    }
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                'buttons' => [
                    ['extend' => 'create', 'className' => 'btn btn-success', 'text' => '<i class="fa fa-plus"> ' . trans('admin.new_shipping_company') . ' </i>'],
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::computed('name_en', trans('admin.name_en'))
                ...
                ->orderable(true)
                ->addClass('text-center'),
            Column::computed('user_id.name', trans('admin.owner_name'))
                ->exportable(true)
                ->searchable(true)
                ->printable(true)
                ->orderable(true)
                ->addClass('text-center'),
            Column::computed('phone', trans('admin.phone'))
                ->exportable(true)
                ->searchable(true)
                ->printable(true)
                ->orderable(true)
    ...
    {
        return 'ShippingCompany' . date('YmdHis');
    }
}
