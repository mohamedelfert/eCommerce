...
class ProductDatatable extends DataTable
{
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                'buttons' => [
                    ['extend' => 'create', 'className' => 'btn btn-success', 'text' => '<i class="fa fa-plus"> ' . trans('admin.new_product') . ' </i>'],
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::computed('id', 'ID')
                ...
                ->orderable(true)
                ->addClass('text-center'),
            Column::computed('title', trans('admin.product_title'))
                ->exportable(true)
                ->searchable(true)
                ->printable(true)
                ->orderable(true)
                ->addClass('text-center'),
            Column::computed('price', trans('admin.product_price'))
                ->exportable(true)
                ->searchable(true)
                ->printable(true)
                ->orderable(true)
