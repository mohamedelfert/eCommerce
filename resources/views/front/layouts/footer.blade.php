                    ...
                    <div class="col-md-8">
                        <div class="copyright">
                            <p>&copy; 2015 uCommerce. All Rights Reserved.
                                <a href="#" target="_blank">freshDesignweb.com</a>
                            </p>
                        </div>
                    </div>
        ...
        <script src="{{ url('design/front/js/jquery.sticky.js') }}"></script>

        <!-- jQuery easing -->
        <script src="{{ url('design/front/js/jquery.easing.1.3.min.js') }}"></script>

        <!-- Main Script -->
        <script src="{{ url('design/front/js/main.js') }}"></script>

        <!-- Slider -->
        <script type="text/javascript" src="{{ url('design/front/js/bxslider.min.js') }}"></script>
        <script type="text/javascript" src="{{ url('design/front/js/script.slider.js') }}"></script>
    </body>
</html>
