    ...
    <div class="card">
        <div class="card-header">
            ...
            <div style="margin-bottom: 10px;">
                <a type="button" class="btn btn-primary btn-sm" style="margin-left: 15px" href="{{ adminUrl('sizes') }}">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            {!! Form::open(['url'=>adminUrl('sizes/'.$size->id),'files'=>true,'method'=>'PUT','class'=>'form-horizontal']) !!}
            <div class="form-group row">
                {!! Form::label('name_ar',trans('admin.name_ar'),['class'=>'col-sm-2 col-form-label']) !!}
                <div class="col-sm-10">
                    {!! Form::text('name_ar',$size->name_ar,['class'=>'form-control','id'=>'name_ar','placeholder'=>'اسم القياس']) !!}
                </div>
            </div>
            <div class="form-group row">
                {!! Form::label('name_en',trans('admin.name_en'),['class'=>'col-sm-2 col-form-label']) !!}
                <div class="col-sm-10">
                    {!! Form::text('name_en',$size->name_en,['class'=>'form-control','id'=>'name_en','placeholder'=>'Size Name']) !!}
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    {!! Form::select('is_public',['yes'=>trans('admin.yes'),'no'=>trans('admin.no')],$size->is_public,['class'=>'custom-select rounded-0','placeholder'=>'Select ...']) !!}
                </div>
            </div>
