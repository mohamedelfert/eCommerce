    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    {!! Form::text('state_name_ar',old('state_name_ar'),['class'=>'form-control','id'=>'state_name_ar','placeholder'=>'اسم المنطقة / الحي']) !!}
                </div>
            </div>
            <div class="form-group row">
                {!! Form::label('state_name_en',trans('admin.state_name_en'),['class'=>'col-sm-2 col-form-label']) !!}
                <div class="col-sm-10">
                    {!! Form::text('state_name_en',old('state_name_en'),['class'=>'form-control','id'=>'state_name_en','placeholder'=>'State Name']) !!}
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    {!! Form::select('country_id',App\Models\Country::pluck('country_name_'.session('lang'),'id'),
                        old('country_id'),['class'=>'custom-select rounded-0 country_id','placeholder'=>'Select Country']) !!}
                </div>
            </div>
            <div class="form-group row">
