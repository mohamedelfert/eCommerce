...
@section('content')
    ...
    <div class="card">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            {!! Form::open(['url'=>adminUrl('admin/'.$admin->id),'method'=>'PUT','class'=>'form-horizontal']) !!}
                <div class="form-group row">
                    {!! Form::label('name',trans('admin.name'),['class'=>'col-sm-2 col-form-label']) !!}
                    <div class="col-sm-10">
                        {!! Form::text('name',$admin->name,['class'=>'form-control','id'=>'name','placeholder'=>'Admin Name']) !!}
                    </div>
                </div>
                <div class="form-group row">
                    {!! Form::label('email',trans('admin.email'),['class'=>'col-sm-2 col-form-label']) !!}
                    <div class="col-sm-10">
                        {!! Form::email('email',$admin->email,['class'=>'form-control','id'=>'email','placeholder'=>'Admin Email']) !!}
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="mb-3" style="margin-top: 5px">
                    {!! Form::submit(trans('admin.update'),['class'=>'btn btn-primary mb-3','id'=>'send']) !!}
                </div>
            {!! Form::close() !!}
        </div>
    </div>
