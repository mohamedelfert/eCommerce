...
@section('content')
    ...
    <div class="card">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            {!! Form::open(['route'=>'companies.store','files'=>true,'class'=>'form-horizontal']) !!}
            <div class="form-group row">
                {!! Form::label('name_ar',trans('admin.name_ar'),['class'=>'col-sm-2 col-form-label']) !!}
                <div class="col-sm-10">
                    {!! Form::text('name_ar',old('name_ar'),['class'=>'form-control','id'=>'name_ar','placeholder'=>'اسم شركه الشحن']) !!}
                </div>
            </div>
            <div class="form-group row">
                {!! Form::label('name_en',trans('admin.name_en'),['class'=>'col-sm-2 col-form-label']) !!}
                <div class="col-sm-10">
                    {!! Form::text('name_en',old('name_en'),['class'=>'form-control','id'=>'name_en','placeholder'=>'Shipping Company Name']) !!}
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    {!! Form::select('user_id',App\User::where('level','company')->pluck('name','id'),
                        old('user_id'),['class'=>'custom-select rounded-0','placeholder'=>'Select Owner Name']) !!}
                </div>
            </div>
            <div class="form-group row">
