...
@section('content')
    ...
    <div class="card">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            {!! Form::open(['route'=>'trademarks.store','files'=>true,'class'=>'form-horizontal']) !!}
            <div class="form-group row">
                {!! Form::label('name_ar',trans('admin.name_ar'),['class'=>'col-sm-2 col-form-label']) !!}
                <div class="col-sm-10">
                    {!! Form::text('name_ar',old('name_ar'),['class'=>'form-control','id'=>'name_ar','placeholder'=>'اسم العلامة التجارية']) !!}
                </div>
            </div>
            <div class="form-group row">
                {!! Form::label('name_en',trans('admin.name_en'),['class'=>'col-sm-2 col-form-label']) !!}
                <div class="col-sm-10">
                    {!! Form::text('name_en',old('name_en'),['class'=>'form-control','id'=>'name_en','placeholder'=>'Trade Mark Name']) !!}
                </div>
            </div>
            <div class="form-group row">
