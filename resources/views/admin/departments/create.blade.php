...
@section('content')
    ...
    <div class="card">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            {!! Form::open(['route'=>'departments.store','files'=>true,'class'=>'form-horizontal']) !!}
            <div class="form-group row">
                {!! Form::label('department_name_ar',trans('admin.department_name_ar'),['class'=>'col-sm-2 col-form-label']) !!}
                <div class="col-sm-10">
                    {!! Form::text('department_name_ar',old('department_name_ar'),['class'=>'form-control','id'=>'department_name_ar','placeholder'=>'اسم القسم']) !!}
                </div>
            </div>
            <div class="form-group row">
                {!! Form::label('department_name_en',trans('admin.department_name_en'),['class'=>'col-sm-2 col-form-label']) !!}
                <div class="col-sm-10">
                    {!! Form::text('department_name_en',old('department_name_en'),['class'=>'form-control','id'=>'department_name_en','placeholder'=>'Department Name']) !!}
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    {!! Form::textarea('keyword',old('keyword'),['class'=>'form-control','id'=>'keyword','placeholder'=>'Keyword']) !!}
                </div>
            </div>
            <div class="form-group row">
